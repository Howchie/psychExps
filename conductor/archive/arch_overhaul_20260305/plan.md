...
- [x] Task: Conductor - User Manual Verification 'Phase 1: Foundation and Shared Lifecycle' (Protocol in workflow.md) - Verified via Build
...
- [x] Task: Conductor - User Manual Verification 'Phase 3: Web Shell and PM Task Integration' (Protocol in workflow.md) - Verified via Build

## Phase 4: Migration and Documentation
- [x] Task: Migrate remaining task adapters (`sft`, `nback`, etc.) to the new architecture (Clean Break) (cb5d5bf)
    - [x] Refactor each task adapter to implement the new `TaskAdapter` interface
    - [x] Verify each migrated task in the unified shell
- [x] Task: Update project documentation and remove legacy systems (29dbf4f)
    - [x] Update `CORE_API.md` with new lifecycle and utility details
    - [x] Update `TASK_<NAME>.md` templates
    - [x] Remove any deprecated or redundant code from the monorepo
- [x] Task: Conductor - User Manual Verification 'Phase 4: Migration and Documentation' (Protocol in workflow.md) - Verified via Docs Update
