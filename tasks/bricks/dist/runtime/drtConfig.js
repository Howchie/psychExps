import { coerceScopedDrtConfig } from "@experiments/core";
export const defaultBricksScopedDrtConfig = {
    enabled: false,
    scope: "trial",
    key: "space",
...
export function resolveBricksDrtConfig(raw) {
    return coerceScopedDrtConfig(defaultBricksScopedDrtConfig, raw);
}
//# sourceMappingURL=drtConfig.js.map