...
describe('GameState hover_to_clear dynamics', () => {
    it('keeps the visible right edge fixed while hovered at matched process rate', () => {
        const gameState = new GameState(buildConfig(), { seed: 1 });
        const brick = Array.from(gameState.bricks.values())[0];
        ...
        gameState.step(1000);
        const updated = gameState.bricks.get(brick.id);
...
//# sourceMappingURL=game_state.test.js.map